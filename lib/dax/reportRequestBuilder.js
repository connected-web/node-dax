function buildRequest(reportId, parameters, site, client, startdate, enddate, samplingrate) {
	...
	var body = 'parameters={parameters}&itemid={reportId}&startdate={startdate}&enddate={enddate}&site={site}&client={client}&user={user}&password={password}&samplingrate={samplingrate}'
    ...
    .replace('{samplingrate}', enc(samplingrate || 16))
